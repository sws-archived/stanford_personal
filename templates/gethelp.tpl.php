 ...
 * Links
 */
$gethelp = l('Request Assistance', 'https://stanforduniversity.qualtrics.com/SE/?SID=SV_1EK9guIGepRtvwh&Name=' . $username . '&Email=' . $user_email . '&URL=' . $base_url, array('attributes' => array('class' => array('btn', 'btn-request'), 'target' => 'blank')));
?>
...
<p>Do you need help with Stanford Sites Personal? Look no further! We have lots of helpful tips in our user guide. The following pages might get you started:</p>
      <ul>
        ...
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/pages" target="_blank">Pages</a></li>
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/blocks" target="_blank">Blocks</a></li>
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/content-editor" target="_blank">Content editor</a></li>
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/multimedia" target="_blank">Multimedia</a></li>
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/design" target="_blank">Design</a></li>
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/users" target="_blank">Users</a></li>
        <li><a href="https://sites.stanford.edu/jumpstart/user-guide/premium-features" target="_blank">Premium Features</a> (including: news, events, profiles, publications, manage content, footer menu)</li>
      </ul>
